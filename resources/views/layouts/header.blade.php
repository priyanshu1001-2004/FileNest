                        ...
                        <div class="d-flex order-lg-2">
                            ...
                            <div class="dropdown d-flex profile-1">
                                <a href="javascript:void(0)" data-bs-toggle="dropdown"
                                    ...
                                    {{-- Agar database mein avatar hai toh woh dikhayein --}}
                                    <img src="{{ asset('storage/' . auth()->user()->avatar) }}" alt="profile-user"
                                        class="avatar profile-user brround cover-image">
                                    @else
                                    {{-- Agar avatar nahi hai toh user ke naam ka pehla letter dikhayein --}}
                                    <div
                                        class="avatar profile-user brround cover-image bg-primary text-white d-flex align-items-center justify-content-center">
